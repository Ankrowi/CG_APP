...
//		else
//		{
//			MessageBox(hWnd, "MyVeryFirstShader.hlsl", "Missing Shader File", MB_OK);
//		}
//
//		return 0;
//	}
//
//	D3D_SHADER_MACRO Shader_Macros[] = { "TEST", "1", "TCOLOR", "float4(0.0f, 0.0f, 1.0f, 1.0f)", nullptr, nullptr };
//
//	ID3DBlob* pixelBC;
...
//	indexBufDesc.ByteWidth = UINT(sizeof(int) * std::size(indeces));
//
